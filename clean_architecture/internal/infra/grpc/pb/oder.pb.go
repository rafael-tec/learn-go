...
// 	// Verify that runtime/protoimpl is sufficiteently up-to-date.
...
// 	0, // 0: pb.OrderService.OrderResponse:input_type -> pb.CreateOrderRequest
// 	1, // 1: pb.OrderService.OrderResponse:output_type -> pb.OrderResponse
